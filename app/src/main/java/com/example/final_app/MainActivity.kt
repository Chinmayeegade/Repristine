...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupViewPager(viewpager: ViewPager) {
        ...
        adapter.addFragment(ReuseFragment(), "\uD83D\uDCA1")
        adapter.addFragment(ArticlesFragment(), "\uD83D\uDCC4")
        adapter.addFragment(QuestionFragment(), "❓")
        adapter.addFragment(AnswersFragment(), "\uD83C\uDD70️")
        adapter.addFragment(CarbonFootprintFragment(), "\uD83D\uDDA9")
        adapter.addFragment(TrackerFragment(), "\uD83D\uDD04")
        adapter.addFragment(TipsFragment(), "✅")
        adapter.addFragment(StatsFragment(), "\uD83D\uDCCA")
        adapter.addFragment(RecycleFragment(), "♻")
        adapter.addFragment(DocumentationFragment(), "\uD83D\uDCC4")
